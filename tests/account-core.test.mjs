...
test('financeiro considera somente pedidos entregues e soma valores sem erro de centavos', () => {
    const summary = financialSummary([
        { status: 'delivered', updatedAt: new Date('2026-09-08T12:00:00Z'), paymentMethod: 'Pix', totals: { total: 35.10, deliveryFee: 5 }, items: [{ productId: 'a', name: 'Feijoada', price: 30.10, quantity: 1 }] },
        { status: 'delivered', updatedAt: new Date('2026-09-08T13:00:00Z'), paymentMethod: 'Dinheiro', totals: { total: 20.20, deliveryFee: 0 }, items: [{ productId: 'b', name: 'Bebida', price: 10.10, quantity: 2 }] },
